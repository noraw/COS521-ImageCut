function [Seg Id Ncut] = NcutPartition(I, W, sNcut, sArea, id, k)
...
% Seg segments of A
[SegA IdA NcutA] = NcutPartition(I(A), W(A, A), sNcut, sArea, [id '-A'], k);
% I(A): node index at V. A is index at the segment, I
% W(A, A); % weight matrix in segment A

% Seg segments of B
[SegB IdB NcutB] = NcutPartition(I(B), W(B, B), sNcut, sArea, [id '-B'], k);
